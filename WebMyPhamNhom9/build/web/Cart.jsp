                ...
                <div class="px-4 px-lg-0">
                    ...
                    <div class="pb-5">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <!--<a href="#"><button class="btnSub">-</button></a> 
                                                            <strong>${o.mount}</strong>
                                                            <a href="#"><button class="btnAdd">+</button></a>-->
                                                        <form action="updatequanity" method="post">
                                                            <input type="hidden" name="productId" value="${o.id}">
                                                            <button type="submit" name="action" value="decrease" class="btnSub">-</button>
                                                            <strong><fmt:formatNumber pattern="##.#" value="${o.mount}"/></strong>
                                                            <button type="submit" name="action" value="increase" class="btnAdd">+</button>
                                                        </form>
                                                    </td>
                                                    <td class="align-middle">
                                                        ...
                                                        <!--<button class="btn btn-danger delete-btn" data-product-id="${o.id}">Delete</button>-->
                                                    </td>
                                                </tr> 
                                            </c:forEach>
                                        </tbody>
                        ...
                        <div class="row py-5 p-4 bg-white rounded shadow-sm">
                            <div class="col-lg-6">
                                <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold"><strong>Total Quantity:</strong> ${totalquality}</div>                               
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    ...
                                    <c:if test="${not empty cartItems}">
                                        <a href="loadAccount?userId=${sessionScope.acc.id}"  class="btn btn-dark rounded-pill py-2 btn-block">Mua hàng</a>
                                    </c:if>
                                </div>
                            </div>
                        </div>
