...
<html>
    <head>
        ...
        <style>
            ...
            .btn-primary {
                color: #fff;
                background-color: #31373dde !important;
                border-color: #31373dde !important; 
            }
            .list-item{
                color: #343a40 !important;
            }
                            ...
                            <div class="row">
                                ...
                                <aside class="col-sm-7">
                                    <article class="card-body p-5">
                                        ...
                                        <hr>
                                        <a href="addtocart?productId=${detail.id}" class="btn btn-lg btn-primary text-uppercase"> Buy now </a>
